...
\begin{fullwidth}
Driven Lead UI Developer with \textbf{\difftoday{2018}{8}{1}} of experience, committed to crafting impactful, user-focused products with expert-level precision.
\end{fullwidth}
